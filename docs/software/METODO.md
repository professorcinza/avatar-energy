...
*Escopo definido pela arquitetura: o SO é o sistema canônico (base 12), construído pela comunidade — o projeto contribui upstream (SYS-005), nunca bifurca. O software do projeto é **o avatar**: a camada de Gestão da base 03 como código.*
